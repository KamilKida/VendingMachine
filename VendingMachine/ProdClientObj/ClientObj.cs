...
namespace VendingMachine.ProdClientObj
{
    internal class ClientObj: DefaultOptions
    {
        ...
        /// <summary>
        /// Method to send new data to sql database column: 'Transactions' based on: 'moneySpend'.
        /// </summary>
        ...
        /// <summary>
        /// Shows what client has brought, what he spend, sends new date to sql database and ends application.
        /// </summary>
