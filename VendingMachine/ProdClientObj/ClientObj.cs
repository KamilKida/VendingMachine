    ...
    internal class ClientObj: DefaultOptions
    {
        ...
        public void TransactonMechanism(decimal money, int productID, string name) {
           this.broughtSomething = true;
            ...
            ISQLcomunication.SendData($"UPDATE [Money In Machine] SET [Current Money In Machine] = [Current Money In Machine] + {moneySpentFormatted} WHERE ID = 1");
        ...
        /// <summary>
        /// Method to send new data to sql database column: 'Transactions' based on: 'moneySpend' value.
        /// </summary>

        public void SentTransactionsInfo()
        {
