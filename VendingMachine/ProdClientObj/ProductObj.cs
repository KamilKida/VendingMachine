...
namespace VendingMachine.ProdClientObj
{
    internal class ProductObj
    {
        ...
        /// <summary>
        /// Changes amount of product in vending machine for client by minus one. 
        /// </summary>
        public void ChangeAmountClient()
        {
                this.amount -= 1;
        }

        /// <summary>
        /// Changes values of product. For: 'delete' option, changes price and amount to: 0 and name to: 'EMPTY'.
