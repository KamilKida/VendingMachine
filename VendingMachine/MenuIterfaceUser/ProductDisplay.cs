...
namespace VendingMachine.MenuIterface
{
    internal class ProductDisplay : DefaultOptions
    {
        ...
        /// <summary>
        /// Public static metho used to create list of products based on date from database.
        /// </summary>
        /// <returns> New 'ProductObj' object that is automatically added to list called: 'products'. </returns>
