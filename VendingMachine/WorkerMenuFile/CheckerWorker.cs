...
namespace VendingMachine.WorkerMenuFile
{
    internal class CheckerWorker : DefaultOptions
    {
       ...
       public static WorkerObj worker;
        ...
        public void loginCheck(int id) {
            ...
            CheckerWorker.worker = ISQLcomunication.GetWorker(id);
            int attempts = 3;
            ...
            if(loginSuccses == false) {
                ...
                ISQLcomunication.SendData($"INSERT INTO [Workers History] VALUES ('{this.startChecker.ToString("yyyy-MM-dd")}', null, 'Failed login attempt with id: {id}')");
