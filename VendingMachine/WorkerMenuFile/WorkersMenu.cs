    ...
    internal class WorkersMenu : DefaultOptions
    {
        ...
        public void WorkerMenuInterface()
        {
            ...
            while (true)
            {
                ...
                {
                    case "t":
                        transactionWorkerMenu.TransactionsMenuInterface( worker);
                        break;
                    case "h":
                        workerHistoruMenu.WorkersHistoryMenuInterface(worker);
                        break;
                    case "w":
                        workerMenu.WorkersMenuInterface( worker);
                        break;
                    case "m":
                        moneyMenu.MoneyMenuInterface( worker);
                        break;
                    case "p":
                        productMenu.MainProductMenuInterface( worker);
                        break;
                    case "x":
                        Console.Clear();
        ...
        private string WorkerMenuLook(string name)
        {
            ...
            string options = $"t: Show history of transactions. \n" +
                             $"h: Show history of workers actions. \n"+
