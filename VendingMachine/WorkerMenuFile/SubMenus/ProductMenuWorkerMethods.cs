...
namespace VendingMachine.WorkerMenu.SubMenus
{
    internal class ProductMenuWorkerMethods : ProductDisplay 
    {
            ...
            else if (workerChoice == "2" && productId != 0)
            {
                ...
                while (amountToken == true)
                {
                    ...
                    try
                    {
                        ...
                        {
                            Console.Clear();
                            Console.WriteLine("You cannot input negative number. Try again.\n");
                            ToContinue();
                    ...
                    catch (Exception e)
                    {
                        ...
                        Console.Clear();
                        Console.WriteLine("You did not input number. Try again. \n");
                        ToContinue();
                    }
                }
        ...
        public int SearchForProduct(string action)
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    {
                        Console.Clear();
                        Console.WriteLine($"There is no product with place: {workerInput}, in vending machine. \n");
                        ToContinue();
                        continue;
                    }
                }
        ...
        public void DeleteProduct(WorkerObj worker)
        {
            ...
            {
                if (productId == 0) { deleteToken = false; break; }
                Console.Clear();
                ShowOneProduct(productId);
