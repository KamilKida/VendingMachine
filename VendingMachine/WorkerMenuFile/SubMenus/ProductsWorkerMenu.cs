...
namespace VendingMachine.WorkerMenu.SubMenus
{
    internal class ProductsWorkerMenu : ProductMenuWorkerMethods
    {
        ...
        public void MainProductMenuInterface( WorkerObj worker)
        {

            Console.Clear();
            string workerInput = MainProuctsMenuLook();
                ...
                while (productToken == true)
            {
                ...
                {
                    Console.Clear();
                    workerInput = MainProuctsMenuLook();
                }
                firstRun = false;
                    ...
                    switch (workerInput.ToLower())
                    {
                        case "s":
                            Console.Clear();
                            ShowProducts();
                            worker.SendAction("Looked at all products in vending machine. ");
                            Console.WriteLine("----------------------");
                            ToContinue();
                            break;
                        case "l":
                            ...
                            {
                                ProductsLessThenTenInterface( worker);
                            }
                            else { Console.WriteLine("All products are at max capacity (10). \n"); ToContinue(); }
                            break;
                        case "e":
        ...
        private string MainProuctsMenuLook()
        {
            ...
            DefaultMenu("PRODUCT OPTIONS"," ", options, false, true);
        ...
        /// <summary>
        /// This is logic behind worker products menu with amount less then max (10). 
        /// Uses switch statements based on user input using: 'ProductsLessThenTenMenuLook()' method.
        /// </summary>
        ///  <param name="worker">'WorkerObj' object used for send actions to database using: 'SendAction()' method.</param>

        private void ProductsLessThenTenInterface( WorkerObj worker) {
            ...
            while (productLessToken == true)
            {
                ...
                string workerInput = ProductsLessThenTenMenuLook();
                ...
                switch (workerInput.ToLower())
                {
                    ...
                    case "o":
                        Console.Clear();
                        OneProductLessThenTenInterface( worker);
                        break;
                    case "x":
                        productLessToken = false;
                        break;
        ...
        /// <summary>
        /// This is logic behind worker one product menu with amount less then max (10). 
        /// Uses switch statements based on user input using: 'OneProductRefilMenuLook()' method.
        /// </summary>
        ///  <param name="worker">'WorkerObj' object used for sending actions to database using: 'SendAction()' method.</param>

        private void OneProductLessThenTenInterface( WorkerObj worker)
        {
            ...
            while (oneProductLessToken == true)
            {
                ...
                string workerInput = OneProductRefilMenuLook();
                ...
                switch (workerInput.ToLower())
                {
                    case "f":
                        ...
                        Console.WriteLine($"Product: {productName} has been refilled to full capacity (10). \n");
                        ToContinue();
                        break;
                    case "c":
                        Console.Clear();
        ...
        private string OneProductRefilMenuLook()
        {
            string options = "f: Refill product to full capicity (10). \n" +
                             "c: Refil product to capcity lower then ten. ";

            DefaultMenu("ONE PRODUCT REFIL OPTIONS", " ", options, false,true);
            string workerInput = Console.ReadLine();
            return workerInput;
        ...
        /// <summary>
        /// This is logic behind worker edit product menu . 
        /// Uses switch statements based on user input using: 'EditProductMenuLook()' method.
        /// </summary>
        ///  <param name="worker">'WorkerObj' object used for sending actions to database using: 'SendAction()' method.</param>
