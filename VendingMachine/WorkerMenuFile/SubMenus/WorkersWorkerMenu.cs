...
namespace VendingMachine.WorkerMenu.SubMenus
{
    internal class WorkersWorkerMenu :DefaultOptions
    {
        ...
        public void WorkersMenuInterface( WorkerObj worker)
        {
            Console.Clear();
            string workerInput = WorkersMenuLook();
        ...
        private string WorkersMenuLook()
        {
            ...
            DefaultMenu("OPERATIONS ON WORKERS MENU"," ", options, false, true);
        ...
        private void AddNewWorker(WorkerObj worker)
        {
            ...
            if(newNameSurname.ToLower() == "x") { Console.Clear(); Console.WriteLine("Operation to add new worker was stopped.\n"); ToContinue(); return; }
            Console.WriteLine(" ");
            Console.Write("Input login: ");
            string newLogin = Console.ReadLine();
            if (newLogin.ToLower() == "x") { Console.Clear(); Console.WriteLine("Operation to add new worker was stopped.\n"); ToContinue(); return; }
            Console.WriteLine(" ");
            Console.Write("Input password: ");
            string newPassword = Console.ReadLine();
            if (newPassword.ToLower() == "x") { Console.Clear(); Console.WriteLine("Operation to add new worker was stopped.\n"); ToContinue(); return; }
            Console.WriteLine(" ");
            ...
            Console.Clear();
            Console.WriteLine("New worker was added.\n");
            ToContinue();
        }
