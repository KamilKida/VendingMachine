...
namespace VendingMachine.WorkerMenu.SubMenus
{
    internal class WorkersWorkerMenu :DefaultOptions
    {
                ...
                firstRun = false;
                    ...
                    switch (workerInput.ToLower())
                    {
                        case "s":
                            Console.Clear();
                            ShowWorkers();
                            worker.AddAction("Looked at workers list. ");
                            Console.WriteLine("----------------------\n");
                            ToContinue();
                            break;
                        case "a":
        ...
        private void AddNewWorker(WorkerObj worker)
        {
            ...
            Console.WriteLine(" ");
            ISQLcomunication.SendDate($"INSERT INTO Workers VALUES ('{newNameSurname}', '{newLogin}', '{newPassword}')");
            worker.AddAction("Added new worker.");
        ...
        /// <summary>
        /// Show all workers on: 'workerslist' list.
        /// </summary>
                ...
                if (IsThereAWorker(worId) == true)
                    {
                        ...
                        {
                            Console.Clear();
                            worker.AddAction($"Deleted worker with id: {worId} from worker list. ");
                            RemoveWorker(int.Parse(worId));
                            ISQLcomunication.SendDate($"delete Workers where [Worker ID] = {int.Parse(worId)}");
        ...
        /// <summary>
        /// Checks if there is worker wit Id inputed by worker.
        /// </summary>
        ...
        /// </summary>
        /// <param name="id">ID of worker information/s about you want to change.</param>
        ...
        /// <param name="workerDif">'WorkerObj' object used for adding actions to worker using: 'AddAction()' method.</param>
        ...
        /// </summary>
        /// <param name="id">ID of worker information about you want to change</param>
        /// <param name="worker">'WorkerObj' object used for adding actions to worker using: 'AddAction()' method.</param>
